...
const metrics: {
...
}[] = [
  {
    ...
    comparison: "Model confidence stable — focus ICU + imaging first.",
  ...
  },
  {
    ...
    comparison: "Backlog growing slowly — batch Radiology this week.",
    filterParam: "overdue",
    icon: Wrench,
    focal: false,
  },
  {
    ...
    comparison: "MTTR improving — fewer imaging escalations this period.",
    filterParam: null,
    icon: Clock,
    focal: false,
  },
  {
    ...
    comparison: "Within target band for acute sites.",
    filterParam: null,
    icon: CheckCircle,
    focal: false,
  },
