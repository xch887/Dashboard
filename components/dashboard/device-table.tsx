...
const devices: DeviceRow[] = [
  {
    ...
    risk: "High",
    action: "Joint Commission PM window missed",
  ...
  },
  {
    ...
    department: "Imaging",
    risk: "Med",
    action: "Telemetry gap — dispatch field check",
  ...
  },
  {
    ...
    department: "ICU",
    risk: "Low",
    action: "Firmware staged — push after shift",
  ...
  },
  {
    ...
    department: "Imaging",
    risk: "Low",
    action: "Routine calibration follow-up",
  ...
  },
  {
    ...
    risk: "None",
    action: "Monitor trend — no patient impact",
